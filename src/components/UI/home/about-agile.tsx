...
export default function AboutAgil() {
  ...
  return (
    <Box id="AboutAgil" sx={{ paddingTop: "40px" }}>
      <SectionContent>
          ...
          <Grid item xs={12} md={7}>
            <Box sx={{ minHeight: 552, width: "95%", height: "100%" }}>
              <Box sx={{ display: "flex", flexDirection: "column" }}>
                ...
                <Typography>
                  A Aceleradora Ágil nasceu para transformar realidades. Criada
                  pela ThoughtWorks em parceria com a PUCRS, Globo e TecnoPUC,
                  ela conecta pessoas que muitas vezes não se viam na tecnologia
                  a um espaço onde aprender, criar e crescer é possível.
                </Typography>
                <Box
                  sx={{
                    display: "flex",
                ...
                >
                  ...
                  <Box sx={theme.customStyles.cardAboutAgilContainer}>
                    <Box sx={theme.customStyles.cardAboutAgil}>
                      <Typography>
                        Uma <strong>plataforma de estudo</strong> gratuita e
                        aberta, o e-Acelera, onde qualquer pessoa pode começar
                        sua jornada no seu ritmo.
                      </Typography>
                    </Box>
                    <Box sx={theme.customStyles.cardAboutAgil}>
                      <Typography>
                        Um <strong>programa de estágio</strong> intensivo de 18
                        semanas, voltado para quem quer entrar no mercado de
                        tecnologia com formação prática e vivência real.
                      </Typography>
                    </Box>
                  </Box>
                  <Typography>
                    Acreditamos em uma tecnologia feita por muitas mãos. Esse é
                    o propósito que também move a{" "}
                    <Link
                      target="_blank"
                ...
                <Box sx={{ display: { xs: "none", sm: "none", md: "block" } }}>
                  <Link sx={{ ":hover": { backgroundColor: "transparent !important" } }} href="#study-section">{AceleraButton}</Link>
                </Box>
              </Box>
            </Box>
          </Grid>
